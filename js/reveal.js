...
export default function( revealElement, options ) {
	...
	function dispatchSlideChanged( origin ) {
		...
		let boolAutoSlide = currentSlide.getAttribute( 'data-autoslide-auto' );

		let boolvolumehalf = currentSlide.getAttribute( 'volumehalf' );
		...
		let boolvolumefull = currentSlide.getAttribute( 'volumefull' );
		...
		let boolstopaudio = currentSlide.getAttribute( 'stop-audio' );
		...
		let boolstartaudio = currentSlide.getAttribute( 'start-audio' );
		...
		let qnum = currentSlide.getAttribute( 'q-num' );
		...
		if( fragmentAutoSlide ) {
			...
			if( !autoSlidePlayer ) {
				...
				autoSlidePlayer.on( 'click', onAutoSlidePlayerClick );
				autoSlidePaused = boolAutoSlide === '' ? false : true;
			}
		}
